...
export const MENU_FONTS: Record<MenuFontKey, { label: string; note: string; stack: string; italic: boolean }> = {
  caslon: { label: 'Caslon', note: 'Thin, high-contrast italic with the house voice.', stack: '"Cormorant Garamond", Georgia, serif', italic: true },
  playfair: { label: 'Playfair', note: 'Rounder, heavier serif with a warmer italic.', stack: '"Playfair Display", Georgia, serif', italic: true },
  baskerville: { label: 'Baskerville', note: 'Bookish and steady with its best reading in print.', stack: '"Libre Baskerville", Georgia, serif', italic: false },
