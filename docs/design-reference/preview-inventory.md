...
| DASHBOARD | Profile and table-history dashboard | Light | `/design-preview/events?theme=light` | No | Avatar placeholder, event-card art, lace artwork | Yes |
| DASHBOARD | Profile and table-history dashboard | Dark | `/design-preview/events?theme=dark` | No | Avatar placeholder, event-card art, lace artwork | Yes |
...
| DASHBOARD | Compact event invitation summary | Light | `/design-preview/events/demo?state=compact` | No | Invitation paper texture | Yes |
| DASHBOARD | Expanded event details with menu/guests/details accordions | Light | `/design-preview/events/demo?state=expanded` | No | Icons and paper texture | Yes for structure; body copy is small |
| DASHBOARD | RSVP response-card selection | Dark | `/design-preview/events/demo?state=rsvp` | No | Three perforated response cards | Yes |
...
| INVITE | Lace-paper invitation template | Light | `/design-preview/invite?template=lace` | No | Lace invitation artwork | Yes; isolated artwork required |
...
| LIGHT APPLICATION COLLECTION | Kitchen/menu highlights | Light | `/design-preview/menu?theme=light` | No | Four food photographs | Yes |
...
| LIGHT APPLICATION COLLECTION | Profile and table history | Light | `/design-preview/profile?theme=light` | No | Event-history icons/avatar treatment | Yes |
...
| DARK APPLICATION COLLECTION | Curated menu highlights | Dark | `/design-preview/menu?theme=dark` | No | Four food photographs | Yes |
...
| DARK APPLICATION COLLECTION | Profile and table history | Dark | `/design-preview/profile?theme=dark` | No | Event-history icons/avatar treatment | Yes |
