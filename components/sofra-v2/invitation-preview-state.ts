...
export interface PreviewInvitationState { title?: string; dateTime?: string; location?: string; dressCode?: string; placeId?: string; latitude?: number; longitude?: number; venueName?: string; theme: PreviewInvitationTheme; imageDataUrl?: string; imageName?: string }
