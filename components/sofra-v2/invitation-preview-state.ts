...
export interface PreviewInvitationState { title?: string; dateTime?: string; location?: string; theme: PreviewInvitationTheme; imageDataUrl?: string; imageName?: string }
...
export function writePreviewInvitation(state: PreviewInvitationState){sessionStorage.setItem(PREVIEW_INVITATION_KEY,JSON.stringify(state))}
