...
export interface PreviewSession{phone:string;name:string;role:PreviewRole;rsvpStatus:'going'|'tentative'|'declined'|null;preferencesSubmitted:boolean;inventoryUpdated:boolean;activeSofra:string;profilePhoto?:string;sharedAlbumPhotos:string[]}
export const EMPTY_PREVIEW_SESSION:PreviewSession={phone:'',name:'',role:null,rsvpStatus:null,preferencesSubmitted:false,inventoryUpdated:false,activeSofra:'laylas-sofra',sharedAlbumPhotos:[]}
