...
export function InvitePreview() {
  ...
  return <div className={`sv2-root sv2-device-page sv2-invite-page ${sv2Display.variable} ${sv2Sans.variable}`}><main className="sv2-device-shell sv2-invite-shell">
    ...
    <div className="sv2-invite-choices"><button type="button" onClick={()=>respond('going')}>SAVE ME A SEAT</button><button type="button" onClick={()=>respond('tentative')}>I&apos;LL THINK ABOUT IT</button><button type="button" onClick={()=>respond('declined')}>MAYBE NEXT TIME</button></div><PreviewBottomNav current="events"/>
  </main></div>
}
