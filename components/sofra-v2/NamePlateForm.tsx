      ...
      <form className="sv2-device-shell sv2-welcome-card sv2-plate-step sv2-name-step sv2-receipt-surface" onSubmit={handleSubmit}>
        ...
        <div className="sv2-plate-wrap sv2-plate-wrap--silver">
          ...
          <div className="sv2-plate-bowl">
            ...
            <input id="sv2-name" className="sv2-plate-input" type="text" value={name} placeholder="e.g. Giada" onChange={(event) => onNameChange(event.target.value)} autoComplete="name" />
          </div>
        </div>
